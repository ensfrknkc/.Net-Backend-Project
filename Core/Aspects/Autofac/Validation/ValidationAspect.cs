...
{
    public class ValidationAspect : MethodInterception //Aspect methodun basında sonunda hata kısmında calısabılecek yapı
    {
        ...
        {
            var validator = (IValidator)Activator.CreateInstance(_validatorType); //instance olusturma
